      ...
      <div className="w-screen fixed top-0 left-0 h-screen flex flex-col z-20 justify-evenly items-center">
        ...
        <div className="w-screen flex flex-col justify-center items-center">
          <div>
            <img
              src={assets.image1}
              className="h-[300px] border-[10px] object-cover rounded-full aspect-square "
              alt=""
            />
          </div>
        </div>
        ...
        <div className="w-screen flex flex-col justify-start items-start h-[200px]">
          <span className="font-Audiowide text-[50px] px-10 -my-0">{time}</span>
          <span className="font-Audiowide text-[25px] px-10 -my-5">{date}</span>
        </div>
